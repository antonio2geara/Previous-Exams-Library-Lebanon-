...
public class ManageDepartment extends javax.swing.JFrame {
    ...
    String departmentid, departmentchair,schoolid;
...
public void setDepartmentDetailsToTable() {
        ...
        try {
            ...
            String departmentChair  = rs.getString("departmentChair");
            String schooLID = rs.getString("schooLID");
           
            Object [] obj = {departmentID,departmentChair,schooLID};
            model =(DefaultTableModel) tbl_managedepartment.getModel();
            model.addRow(obj);
             }
        }catch (Exception e){
          e.printStackTrace();
...
//add universities
      ...
      departmentchair =  txt_chair.getText();
      ...
      try {
          ...
          pst.setString(2, departmentchair);
      ...
      try {
          Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/Library_msj","root","G1e2a3r4++-098");
          String sql = "UPDATE DEPARTMENT SET departmentChair = ?,schooLID = ? WHERE departmentID = ? ";
          PreparedStatement pst = con.prepareStatement(sql);
          pst.setString(1, departmentchair);
          pst.setString(2, schoolid);
          pst.setString(3, departmentid);
     ...
     public void clearTable() {
         DefaultTableModel model = (DefaultTableModel) tbl_managedepartment.getModel();
         model.setRowCount(0);
     }
     ...
     public void search(String str) {
       ...
       tbl_managedepartment.setRowSorter(trs);
    ...
    private void initComponents() {
        ...
        txt_chair = new app.bolivia.swing.JCTextField();
        ...
        tbl_managedepartment = new rojeru_san.complementos.RSTableMetro();
        ...
        jPanel1.add(txt_department, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 140, -1, -1));

        jLabel13.setFont(new java.awt.Font("Swis721 BlkCn BT", 1, 18)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("Enter School");
        ...
        jPanel1.add(txt_school, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 240, -1, -1));

        jLabel4.setFont(new java.awt.Font("Swis721 BlkCn BT", 1, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Enter Chair");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 110, 200, -1));

        txt_chair.setBackground(new java.awt.Color(102, 102, 255));
        txt_chair.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 2, 0, new java.awt.Color(0, 0, 0)));
        txt_chair.setToolTipText("");
        txt_chair.setPlaceholder("Enter Chair");
        txt_chair.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                txt_chairFocusLost(evt);
            }
        });
        txt_chair.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_chairActionPerformed(evt);
            }
        });
        jPanel1.add(txt_chair, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 140, -1, -1));
        ...
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 130, -1, 50));
        ...
        tbl_managedepartment.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tbl_managedepartment.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbl_managedepartmentMouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(tbl_managedepartment);
        ...
        jPanel3.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 620, 310, -1));
    ...
    private void txt_chairFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txt_chairFocusLost
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_chairFocusLost

    private void txt_chairActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_chairActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_chairActionPerformed
    ...
    private void rSMaterialButtonCircle1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSMaterialButtonCircle1ActionPerformed
        if(deletedepartment()== true) {
          ...
          setDepartmentDetailsToTable();
            ...
            JOptionPane.showMessageDialog(this, "Department Deletion Failure");
        }
    ...
    private void rSMaterialButtonCircle2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSMaterialButtonCircle2ActionPerformed
        if(adddepartment() == true) {
          ...
          setDepartmentDetailsToTable();
            ...
            JOptionPane.showMessageDialog(this, "Department Addition Failure");
        }
    ...
    private void rSMaterialButtonCircle3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSMaterialButtonCircle3ActionPerformed
       if(updatedepartment()== true) {
          ...
          setDepartmentDetailsToTable();
            ...
            JOptionPane.showMessageDialog(this, "Department Update Failure");
        } 
    ...
    private void tbl_managedepartmentMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_managedepartmentMouseClicked
        int rowNo= tbl_managedepartment.getSelectedRow();
        TableModel model = tbl_managedepartment.getModel();
        
        txt_department.setText(model.getValueAt(rowNo, 0).toString());
        txt_chair.setText(model.getValueAt(rowNo, 1).toString());
        txt_school.setText(model.getValueAt(rowNo, 2).toString());
    }//GEN-LAST:event_tbl_managedepartmentMouseClicked
    ...
    private rojeru_san.complementos.RSTableMetro tbl_managedepartment;
    private app.bolivia.swing.JCTextField txt_chair;
