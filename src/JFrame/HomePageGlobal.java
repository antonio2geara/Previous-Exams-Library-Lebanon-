...
public class HomePageGlobal extends javax.swing.JFrame {
...
" AND EXAMS.professorID=PROFESSORS.professorID");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HomePageGlobal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HomePageGlobal().setVisible(true);
            }
        });
    }
