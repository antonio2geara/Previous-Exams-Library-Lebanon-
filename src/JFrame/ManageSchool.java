 ...
 * @author Lenovo
 */
public class ManageSchool extends javax.swing.JFrame {

    /**
     * Creates new form ManagePrevious
     */
    String schooliD, school_mail, schoolDean ,universityiD;
    ...
    public ManageSchool() {
     ...
     public void setSchoolDetailsToTable() {
        try {
            ...
            String schoolmail  = rs.getString("schoolmail");
            String schoolDEAN = rs.getString("schoolDEAN");
            String universityID = rs.getString("universityID");
          
            Object [] obj = {schooLID,schoolmail,schoolDEAN ,universityID};
            model =(DefaultTableModel) tbl_manageschool.getModel();
            model.addRow(obj);
             }
        }catch (Exception e){
          e.printStackTrace();
      ...
      schooliD =  txt_school.getText();
      school_mail = txt_schoolmail.getText();
      schoolDean = txt_dean.getText();
    ...
    try {
          ...
          pst.setString(2, school_mail);
          pst.setString(3,schoolDean);      
          pst.setString(4, universityiD);
      ...
      try {
          Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/Library_msj","root","G1e2a3r4++-098");
          String sql = "UPDATE SCHOOL SET  schoolmail = ?, schoolDEAN = ?,universityID = ? WHERE schooLID = ? ";
          PreparedStatement pst = con.prepareStatement(sql);
          
          pst.setString(1,school_mail);
          pst.setString(2, schoolDean); 
          pst.setString(3, universityiD);
          pst.setString(4, schooliD);
     ...
     public void clearTable() {
         DefaultTableModel model = (DefaultTableModel) tbl_manageschool.getModel();
         model.setRowCount(0);
     }
     ...
     public void search(String str) {
       ...
       tbl_manageschool.setRowSorter(trs);
    ...
    private void initComponents() {
        ...
        txt_school = new app.bolivia.swing.JCTextField();
        jLabel13 = new javax.swing.JLabel();
        jLabel14 = new javax.swing.JLabel();
        txt_dean = new app.bolivia.swing.JCTextField();
        jLabel4 = new javax.swing.JLabel();
        txt_schoolmail = new app.bolivia.swing.JCTextField();
        ...
        tbl_manageschool = new rojeru_san.complementos.RSTableMetro();
        ...
        txt_school.setBackground(new java.awt.Color(102, 102, 255));
        txt_school.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 2, 0, new java.awt.Color(0, 0, 0)));
        txt_school.setToolTipText("");
        txt_school.setPlaceholder("Enter School");
        txt_school.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                txt_schoolFocusLost(evt);
            }
        });
        txt_school.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_schoolActionPerformed(evt);
            }
        });
        jPanel1.add(txt_school, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 140, -1, -1));

        jLabel13.setFont(new java.awt.Font("Swis721 BlkCn BT", 1, 18)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("Enter Dean");
        ...
        txt_dean.setBackground(new java.awt.Color(102, 102, 255));
        txt_dean.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 2, 0, new java.awt.Color(0, 0, 0)));
        txt_dean.setToolTipText("");
        txt_dean.setPlaceholder("Enter Dean");
        txt_dean.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_deanActionPerformed(evt);
            }
        });
        jPanel1.add(txt_dean, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 240, -1, -1));
        ...
        txt_schoolmail.setBackground(new java.awt.Color(102, 102, 255));
        txt_schoolmail.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 2, 0, new java.awt.Color(0, 0, 0)));
        txt_schoolmail.setToolTipText("");
        txt_schoolmail.setPlaceholder("Enter Mail");
        txt_schoolmail.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                txt_schoolmailFocusLost(evt);
            }
        });
        txt_schoolmail.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_schoolmailActionPerformed(evt);
            }
        });
        jPanel1.add(txt_schoolmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 140, -1, -1));
        ...
        jPanel1.add(txt_university, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 240, -1, -1));

        jLabel18.setFont(new java.awt.Font("Swis721 BlkCn BT", 1, 18)); // NOI18N
        jLabel18.setForeground(new java.awt.Color(255, 255, 255));
        jLabel18.setText("Enter University");
        ...
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 140, 50, 30));
        ...
        tbl_manageschool.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "School", "Mail", "Dean", "University"
            }
        ));
        tbl_manageschool.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbl_manageschoolMouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(tbl_manageschool);

        jPanel3.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 360, 830, 230));
        ...
        jLabel2.setText("Manage School");
        jPanel3.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 180, 380, 70));
        ...
        jLabel21.setText("Search School");
    ...
    private void txt_schoolActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_schoolActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_schoolActionPerformed

    private void txt_deanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_deanActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_deanActionPerformed

    private void txt_schoolmailFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txt_schoolmailFocusLost
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_schoolmailFocusLost

    private void txt_schoolmailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_schoolmailActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_schoolmailActionPerformed
    ...
    private void rSMaterialButtonCircle2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSMaterialButtonCircle2ActionPerformed
         ...
         if(addschool()== true) {
          ...
          setSchoolDetailsToTable();
            ...
            JOptionPane.showMessageDialog(this, "School Addition Failure");
        }
    ...
    private void rSMaterialButtonCircle3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSMaterialButtonCircle3ActionPerformed
         ...
         if(updateSchool()== true) {
          JOptionPane.showMessageDialog(this, "School Updated"); 
          clearTable();
          setSchoolDetailsToTable();
        }else {
            JOptionPane.showMessageDialog(this, "School Update Failure");
        }
    ...
    private void tbl_manageschoolMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_manageschoolMouseClicked
        
        int rowNo= tbl_manageschool.getSelectedRow();
        TableModel model = tbl_manageschool.getModel();
        
        
        txt_school.setText(model.getValueAt(rowNo, 0).toString());
        txt_schoolmail.setText(model.getValueAt(rowNo, 1).toString());
        txt_dean.setText(model.getValueAt(rowNo, 2).toString());
        txt_university.setText(model.getValueAt(rowNo, 3).toString());
    }//GEN-LAST:event_tbl_manageschoolMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManageSchool.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManageSchool().setVisible(true);
            }
        });
    }
    ...
    private rojeru_san.complementos.RSTableMetro tbl_manageschool;
    private app.bolivia.swing.JCTextField txt_dean;
    private app.bolivia.swing.JCTextField txt_school;
    private app.bolivia.swing.JCTextField txt_schoolmail;
